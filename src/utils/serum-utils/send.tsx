...
export interface SWalletAdapter extends WalletAdapter {
...
export async function listMarket({
  ...
  const signedTransactions = await signTransactions({
    ...
    wallet: wallet as SWalletAdapter,
    connection,
  });
...
// }) {
//   const blockhash = (await connection.getRecentBlockhash('max')).blockhash;
//   transactionsAndSigners.forEach(({ transaction: txn, signers = [] }) => {
