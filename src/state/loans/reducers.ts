...
const setCurrentLoanNftReducer = createReducer<BorrowNft[]>(null, {
  [loansTypes.SET_CURRENT_LOAN_NFT]: (
    __,
    action: ReturnType<typeof loansActions.setCurrentLoanNft>,
  ) => action.payload,
});
...
export default combineReducers({
  ...
  currentLoanNft: setCurrentLoanNftReducer,
});
