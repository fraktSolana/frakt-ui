...
const icon = () => {
  ...
  return (
    <>
      <g clipPath={`url(#clip0_993_4491_${id})`}>
        <path
          ...
          fill={`url(#paint0_linear_993_4491_${id})`}
        />
        <path
          ...
          fill={`url(#paint1_linear_993_4491_${id})`}
        />
        <path
          ...
          fill={`url(#paint2_linear_993_4491_${id})`}
        />
      </g>
      <defs>
        <linearGradient
          id={`paint0_linear_993_4491_${id}`}
          x1="14.5186"
          y1="-1.73044"
          x2="3.60979"
          y2="16.4656"
        ...
        <clipPath id={`clip0_993_4491_${id}`}>
